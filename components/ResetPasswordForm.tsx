...
const ResetPasswordForm: React.FC<ResetPasswordFormProps> = ({ email, onNavigateToLogin, onPasswordResetSuccess }) => {
  ...
  return (
    <div className="flex w-full md:w-1/2 lg:w-5/12 flex-col justify-center items-center bg-background-light dark:bg-background-dark p-6 sm:p-12 relative overflow-y-auto max-h-screen">
      ...
      <div className="w-full max-w-[440px] flex flex-col gap-8 relative z-10 py-6">
        <div className="flex flex-col gap-3">
          ...
          <div>
            <h1 className="text-text-light dark:text-white tracking-tight text-[32px] font-bold leading-tight">Redefinir Senha</h1>
            <p className="text-subtext-light dark:text-subtext-dark text-base font-normal leading-normal mt-2">
                Defina uma nova senha para a conta: <br/>
        ...
        <form className="flex flex-col gap-5">
          ...
          <label className="flex flex-col gap-2">
            <span className="text-text-light dark:text-gray-200 text-sm font-semibold leading-normal">Nova Senha</span>
          ...
          <label className="flex flex-col gap-2">
            <span className="text-text-light dark:text-gray-200 text-sm font-semibold leading-normal">Confirmar Nova Senha</span>
            <div className="relative group">
              <input
                className="flex w-full rounded-lg border border-[#d3dbe4] dark:border-gray-700 bg-white dark:bg-gray-900 px-4 h-14 pr-12 text-base text-text-light dark:text-white placeholder:text-[#94a3b8] focus:border-accent focus:ring-1 focus:ring-accent focus:outline-none transition-all duration-200 shadow-sm group-hover:border-gray-400 dark:group-hover:border-gray-500"
                placeholder="********"
        ...
        <div className="text-center pt-2">
             <button 
                ...
                className="inline-flex items-center gap-2 font-bold text-gray-500 hover:text-gray-700 transition-colors group text-sm cursor-pointer"
            >
                Cancelar
            </button>
        </div>
