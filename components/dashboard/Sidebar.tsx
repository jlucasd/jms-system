                ...
                <nav className="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
                    ...
                    <div className="pt-2">
                        ...
                        <a 
                            ...
                            className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all text-sm mb-1 ${activePage === 'clients' ? activeClasses : inactiveClasses}`}
                        >
                            <span className={iconClasses(activePage === 'clients')}>groups</span>
                            Clientes
                        </a>
